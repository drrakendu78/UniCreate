...
- Silent update no longer flashes a CMD window.
...
### 1) Silent update fix
- Added `CREATE_NO_WINDOW` (0x08000000) flag via `.creation_flags()` on the PowerShell process.
- Combined with `-WindowStyle Hidden`, the update is now fully invisible.
...
|---|---:|---|
| `UniCreate_1.0.3_x64-setup.exe` | 11262342 | `d66c0137b44f65519f8f516ad7d099716e69b854f6ebb661968fc644bb6f5ae5` |
| `UniCreate_1.0.3_x64_en-US.msi` | 13373440 | `cb0495f5c755c386677f909155322803864c12e76a2ee07abcbf66efc41f4875` |
| `UniCreate_1.0.3_x64_portable.exe` | 24466944 | `1eb238bb6845c12e7363604853434735f2576d7182cd3a08caace0060ce2d19a` |
